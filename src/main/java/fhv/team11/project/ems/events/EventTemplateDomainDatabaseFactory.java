...
@Component
public class EventTemplateDomainDatabaseFactory extends DomainDatabaseFactory implements ISimpleDomainDatabaseMapper<EventTemplate, EventTemplateEntity>, IHandleDomainPersistence<EventTemplate> {

    private final AddressDomainDatabaseFactory addressDomainDatabaseFactory;
    private final EventTemplateRepository eventTemplateRepository;

    @Autowired
    public EventTemplateDomainDatabaseFactory(AddressDomainDatabaseFactory addressDomainDatabaseFactory, EventTemplateRepository eventTemplateRepository) {
        this.addressDomainDatabaseFactory = addressDomainDatabaseFactory;
        this.eventTemplateRepository = eventTemplateRepository;
    }

    @Override
    public EventTemplateEntity toNotPersistedEntity(EventTemplate domain) {
        ...
        entity.setAddressEntity(addressDomainDatabaseFactory.toNotPersistedEntity(domain.getAddress()));
    ...
    public EventTemplate toDomain(EventTemplateEntity entity) throws DomainValidationException {
        Address address = addressDomainDatabaseFactory.toDomain(entity.getAddressEntity());
    ...
    public EventTemplate persist(EventTemplate domainObject) throws DomainValidationException {
        return this.toDomain(eventTemplateRepository.save(toNotPersistedEntity(domainObject)));
    }
}
