...
public class DateDifferenceValidation implements ConstraintValidator <DateDifference, SortedSet<ActiveEventDateDTO>>{
    ...
    @Override
    public boolean isValid(SortedSet<ActiveEventDateDTO> activeEventDates, ConstraintValidatorContext context) {
        ...
        for (ActiveEventDateDTO eventDate : activeEventDates) {
